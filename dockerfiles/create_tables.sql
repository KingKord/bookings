...
INSERT INTO "public"."reservations"("id", "first_name", "last_name", "email", "phone", "start_date", "end_date", "room_id", "created_at", "updated_at", "processed")
VALUES
...
-- Для таблицы room_restrictions
INSERT INTO "public"."room_restrictions"("id", "start_date", "end_date", "room_id", "reservation_id", "restriction_id", "created_at", "updated_at")
VALUES
    (1, '2021-02-05', '2021-02-06', 1, NULL, 2, '2021-02-08 11:14:24.940013', '2021-02-08 11:14:24.940014'),
    (3, '2021-11-10', '2021-11-11', 1, NULL, 2, '2021-11-14 00:00:00', '2021-11-14 00:00:00'),
    (4, '2022-07-27', '2022-07-29', 1, 2, 1, '2022-07-25 09:31:34.34671', '2022-07-25 09:31:34.34671');

-- Для таблицы rooms
INSERT INTO "public"."rooms"("id", "room_name", "created_at", "updated_at")
VALUES
    (1, 'General''s Quarters', '2020-11-18 00:00:00', '2020-11-18 00:00:00'),
    (2, 'Major''s Suite', '2020-11-19 00:00:00', '0202-11-19 00:00:00');

-- Для таблицы schema_migration
...
--
INSERT INTO "public"."users"("id", "first_name", "last_name", "email", "password", "access_level", "created_at", "updated_at")
VALUES
    (1, 'Trevor', 'Sawler', 'admin@admin.com', '$2a$12$YPum98Xw2BTAsIbLyigis.YKqoWiGcGrLUhitJAukdqOFXnQFtk6K', 3, '2020-12-04 00:00:00', '2020-12-04 00:00:00');
